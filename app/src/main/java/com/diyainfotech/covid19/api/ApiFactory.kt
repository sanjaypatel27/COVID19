...
object ApiFactory {
    ...
    val covid19IndiaData: Covid19IndiaInterface =
        retrofit(httpClient).create(Covid19IndiaInterface::class.java)
    val covid19NotificationList: Covid19IndiaInterface =
        retrofit(httpClient).create(Covid19IndiaInterface::class.java)
}